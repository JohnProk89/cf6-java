package gr.aueb.cf.ch10.fiveprojects.solutions;
...
public class Project1 {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/tmp/lotto5in.txt"));
            ...
            while ((num = in.nextInt()) != -1 && pivot <= 48) { // Getting NoSuchElementException seems like if input is exhausted...
                // like the is nothing more to read, while the scanner expects to read an integer...
                // Alternative while
//                 (in.hasNextInt() && pivot <= 48) {
//                 num = in.nextInt();
