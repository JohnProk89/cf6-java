package gr.aueb.cf.ch10.pdf10.cryptography;
 ...
 * (β) παίρνοντας το υπόλοιπο της διαίρεσης του αθροίσματος αυτού δια μία σταθερά.
 * Υποθέτουμε πως τα μηνύματα τελειώνουν με τον χαρακτήρα #
 * Γράψτε ένα πρόγραμμα java που να υλοποιεί τον αλγόριθμο κρυπτογράφησης
 * έτσι ώστε το κωδικοποιημένο μήνυμα που προκύπτει να είναι μία ακολουθία ακεραίων που τελειώνει με -1
...
public class CryptoSolved {
    ...
    public static char decipher(int cipher, int prev, int key) {
        ...
        // πάρουμε θετικό και άρα να τρέξει σωστό το modulo
