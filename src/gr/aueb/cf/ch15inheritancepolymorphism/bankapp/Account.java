package gr.aueb.cf.ch15inheritancepolymorphism.bankapp;

import gr.aueb.cf.ch15inheritancepolymorphism.bankapp.exceptions.InsufficientBalanceException;
import gr.aueb.cf.ch15inheritancepolymorphism.bankapp.exceptions.NegativeAmountException;
import gr.aueb.cf.ch15inheritancepolymorphism.bankapp.exceptions.SsnNotValidException;
...
//        this.holder = holder;
    ...
    /**
     * Deposits a certain amount of money into user's {@link Account}, thus increasing the {@link Account#balance}
    ...
    /**
     * Withdraws an amount of money form an {@link Account}
