package gr.aueb.cf.ch7strings.exercises.solutions;
...
//            if (Character.isAlphabetic(ch)) encrypted.append(cipher(ch, key));
    ...
    public static char decipher(char ch, int key) {
        ...
        // message (char) position in 0-25
        // (English alphabet /Uppercase)
        c = ch - 65; // transform in 0 - 25 size

        // decipher position in 0 - 25
        // Αν το key είναι > 26 το c-key+26 είναι αρνητικό - remove key, add 26 to use mod...
        // Μπορούμε να πάρουμε
        m = (c - key + 26 * (Math.abs(c-key) + 1)) % 26; // ensure positive by multiplication

        return (char) (m + 65); // transform to ascii...
    }
}
