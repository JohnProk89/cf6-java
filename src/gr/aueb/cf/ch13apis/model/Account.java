...
public class Account {
    ...
    /**
     * Withdraws an amount of money from an {@link Account} based on a valid ssn
     * @param amount the amount of money to withdraw
     * @param ssn the given ssn
     * @throws Exception if the balance is insufficient or if the ssn is not valid
     */
     ...
     * @return the {@link Account}'s balance
     */
     ...
     * @return the String-representation of the state of the {@link Account}
     */
